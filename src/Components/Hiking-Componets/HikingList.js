...
class HikingList extends React.Component {
    constructor (props) {
        super(props);
        this.state = {
            results: [],
            ...
            <main className="main-class">
                ...
                <table className="list-table">
                    ...
                    <tr className="list-tr">
                         ...
                         {this.state.hikinghat.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikinghat'>Add Hiking Hat</a></td> : <td className="list-td">{this.state.hikinghat.name}</td>}
                    ...
                    {this.state.hikinghat.name.length !== 0 ? 
                          ...
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikinghat'>Add Extra Hiking Hat</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.windbreaker.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=windbreaker'>Add Windbreakers</a></td> : <td className="list-td">{this.state.windbreaker.name}</td>}
                    ...
                    {this.state.windbreaker.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=windbreaker'>Add Extra Windbreaker</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.hikingshirt.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingshirt'>Add hikingshirt</a></td> : <td className="list-td">{this.state.hikingshirt.name}</td>}
                    ...
                    {this.state.hikingshirt.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingshirt'>Add Extra hikingshirt</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.hikingpants.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingpants'>Add hikingpants</a></td> : <td className="list-td">{this.state.hikingpants.name}</td>}
                    ...
                    {this.state.hikingpants.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingpants'>Add Extra hikingpants</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.hikingpants.name.length !== 0 ? <td className="list-td" ><img className="list-image" src={this.state.hikingpants.image} /></td> : <td className="no-td"></td>}
                         {this.state.hikingpants.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingpants'>Add Pants</a></td> : <td className="list-td">{this.state.hikingpants.name}</td>}
                         {this.state.hikingpants.name.length === 0 ? <td className="no-td"></td> : <td className="list-td">${this.state.hikingpants.price}</td>}
                         {this.state.hikingpants.name.length !== 0 ? <td className="list-td"><button className="buybutton" onClick={this.buyNow.bind(this)} value={this.state.hikingpants.link}>Buy Now!</button></td> : <td className="no-td"></td>}
                         {this.state.hikingpants.name.length !== 0 ? <td className="list-td"><button className="list-delete" value="hikingpants" onClick={this.handleDelete.bind(this)}>X</button></td> : <td className="no-td"></td>}
                    </tr>
                    ...
                    {this.state.hikingpants.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingpants'>Add Extra Pants</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.hikingboot.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingboot'>Add Hiking Boots</a></td> : <td className="list-td">{this.state.hikingboot.name}</td>}
                    ...
                    {this.state.hikingboot.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingboot'>Add Extra Hiking Boots</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    ...
                    <tr className="list-tr">
                         ...
                         {this.state.hikingbackpack.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingbackpack'>Add Backpack</a></td> : <td className="list-td">{this.state.hikingbackpack.name}</td>}
                    ...
                    {this.state.hikingbackpack.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=hikingbackpack'>Add Extra Backpack</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.bladder.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=bladder'>Add Water Bladder/Container</a></td> : <td className="list-td">{this.state.bladder.name}</td>}
                    ...
                    {this.state.bladder.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=bladder'>Add Extra Water Bladder/Container</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    ...
                    <tr className="list-tr">
                         ...
                         {this.state.headlamp.name.length === 0 ? <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=headlamp'>Add Headlamp</a></td> : <td className="list-td">{this.state.headlamp.name}</td>}
                    ...
                    {this.state.headlamp.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=headlamp'>Add Extra Headlamp</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.compass.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=compass'>Add Compass</a></td> : <td className="list-td">{this.state.compass.name}</td>}
                    ...
                    {this.state.compass.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=compass'>Add Extra Compass</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.knive.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=knive'>Add Knives</a></td> : <td className="list-td">{this.state.knive.name}</td>}
                    ...
                    {this.state.knive.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=knive'>Add Extra Knives</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.trekkingpoles.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=trekkingpoles'>Add Trekking Poles</a></td> : <td className="list-td">{this.state.trekkingpoles.name}</td>}
                    ...
                    {this.state.trekkingpoles.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=trekkingpoles'>Add Extra Trekking Poles</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.essentialsmisc.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=essentialsmisc'>Add Misc Essentials</a></td> : <td className="list-td">{this.state.essentialsmisc.name}</td>}
                    ...
                    {this.state.essentialsmisc.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=essentialsmisc'>Add Extra Misc Essentials</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    ...
                    <tr className="list-tr">
                         ...
                         {this.state.medical.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=medical'>Add Medical Kits</a></td> : <td className="list-td">{this.state.medical.name}</td>}
                    ...
                    {this.state.medical.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=medical'>Add Extra Medical Kits</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.waterpurifier.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=waterpurifier'>Add Water Purifier</a></td> : <td className="list-td">{this.state.waterpurifier.name}</td>}
                    ...
                    {this.state.waterpurifier.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=waterpurifier'>Add Extra Water Purifier</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.firestarter.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=firestarter'>Add Fire Starter</a></td> : <td className="list-td">{this.state.firestarter.name}</td>}
                    ...
                    {this.state.firestarter.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=firestarter'>Add Extra Fire Starter</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    <tr className="list-tr">
                         ...
                         {this.state.gps.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=gps'>Add GPS</a></td> : <td className="list-td">{this.state.gps.name}</td>}
                    ...
                    {this.state.gps.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=gps'>Add Extra GPS</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
                    ...
                    <tr className="list-tr">
                         ...
                         {this.state.misc.name.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=misc'>Add Misc Gear</a></td> : <td className="list-td">{this.state.misc.name}</td>}
                    ...
                    {this.state.misc.name.length !== 0 ? 
                          ...
                          <td className="no-td"></td>
                          <td className="list-td" ><a className="newlist-a" href='https://outdoorgearpicker.now.sh/edithikingproductsearch?type=misc'>Add Extra Misc Gear</a></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                          <td className="no-td"></td>
                    </tr> : null}
