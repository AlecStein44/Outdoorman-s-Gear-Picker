...
class FishingEditProductSearch extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            results: [],
    ...
    render() {
        return(
            <main>
                ...
                <button className="list-back" onClick={() => { window.location.assign('https://outdoorgearpicker.herokuapp.com/fishinglist') }}>Back</button>
            </main>
        )
    }
}

export default FishingEditProductSearch
