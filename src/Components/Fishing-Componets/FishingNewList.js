            ...
            <main className="main-class">
                ...
                <table className="list-table">
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.reel.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=reel'>Add Reel</a></td> : <td className="list-td">{this.state.reel}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.bait.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=bait'>Add Bait</a></td> : <td className="list-td">{this.state.bait}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.headwear.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=headwear'>Add HeadWear</a></td> : <td className="list-td">{this.state.headwear}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.vest.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=vest'>Add Vest</a></td> : <td className="list-td">{this.state.vest}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.pants.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=pants'>Add Pants</a></td> : <td className="list-td">{this.state.pants}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.hooks.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=hooks'>Add Hooks</a></td> : <td className="list-td">{this.state.hooks}</td>}
                   ...
                   <tr className="list-tr">
                        ...
                        {this.state.tacklebox.length === 0 ? <td className="list-td"><a className="newlist-a" href='https://outdoorgearpicker.now.sh/fishingproductsearch?type=tacklebox'>Add Tackle Box</a></td> : <td className="list-td">{this.state.tacklebox}</td>}
